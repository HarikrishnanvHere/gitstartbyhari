...
let inputOne = document.getElementById("item");
let inputTwo = document.getElementById("item-description");

let labelOne = document.createElement("label");
labelOne.textContent = "Item Number";
labelOne.setAttribute("for","item");
form.insertBefore(labelOne,inputOne);


let labelTwo = document.createElement("label");
labelTwo.textContent = "Item Description";
labelTwo.setAttribute("for","item-description");
form.insertBefore(labelTwo,inputTwo);
...
function addItem(e){
  ...
  let newItemDesc = document.getElementById('item-description').value;
  let newText = newItem +" "+ newItemDesc;
  ...
  editButtonele.className = 'btn btn-danger btn-sm float-right delete';
  let textOfEdit = document.createTextNode("Edit");
  editButtonele.appendChild(textOfEdit);
  li.appendChild(editButtonele);
